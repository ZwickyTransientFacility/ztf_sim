...
def Qin_2024A_selection(time, obs_log, other_program_fields, fields,
        skymaps, silent=False):
    """Select unobserved prioritized fields for Qin 2024"""

    # candidate field IDS in priority order
    candidate_field_ids = [699, 700, 225, 372, 574, 651, 698, 650, 624, 732, 575, 652, 321, 691, 226, 322,
626, 653, 266, 406, 346, 747, 267, 656, 219, 369, 349, 403, 272, 550, 345, 836,
548, 567, 274, 224, 525, 528, 473, 452, 697, 273, 417, 692, 718, 662, 354, 561,
241, 835, 237, 497, 317, 401, 629, 202, 649, 616, 503, 625, 621, 733, 398, 837,
647, 204, 476, 858, 601, 396, 740, 674, 371, 421, 636, 397, 271, 623, 402, 351,
399, 423, 446, 373, 472, 600, 671, 599, 739, 857, 350, 365, 746, 312, 654, 789,
571, 583, 304, 290, 637, 523, 667, 811, 608, 355, 663, 357, 455, 622, 404, 218,
860, 315, 319, 673, 439, 604, 440, 572, 424, 498, 814, 246, 871, 617, 450, 405,
589, 201, 275, 753, 719, 457, 448, 711, 348, 856, 666, 227, 614, 414, 560, 672,
306, 499, 605, 527, 874, 818, 364, 648, 305, 578, 400, 524, 318, 761, 788, 449,
529, 715, 790, 748, 841, 720, 609, 485, 859, 543, 456, 783, 453, 425, 875, 721,
825, 522, 300, 838, 568, 251, 676, 291, 588, 655, 581, 419, 467, 706, 203, 555,
326, 484, 734, 258, 496, 813, 301, 824, 736, 613, 416, 500, 683, 230, 536, 819,
519, 502, 475, 470, 325, 675, 738, 537, 646, 276, 287, 840, 296, 505, 222, 549,
504, 745, 477, 576, 264, 693, 542, 297, 511, 228, 370, 238, 558, 205, 445, 839,
849, 554, 229, 565, 750, 231, 587, 447, 388, 861, 579, 265, 516, 710, 367, 661,
422, 313, 684, 252, 580, 573, 299, 755, 471, 615, 407, 842, 760, 314, 250, 531,
262, 337, 451, 870, 415, 248, 209, 347, 362, 620, 628, 295, 220, 420, 341, 696,
532, 490, 602, 551, 466, 685, 418, 464, 544, 594, 380, 793, 307, 216, 638, 468,
368, 491, 855, 352, 239, 366, 533, 358, 286, 469, 577, 520, 387, 618, 278, 556,
316, 444, 474, 631, 259, 342, 754, 712, 223, 441, 426, 854, 812, 584, 454, 570,
737, 394, 510, 717, 797, 695, 323, 705, 784, 249, 270, 772, 826, 582, 598, 682,
843, 458, 644, 507, 569, 728, 553, 821, 610, 508, 263, 881, 408, 213, 363, 257,
377, 800, 815, 716, 630, 311, 526, 395, 714, 437, 432, 463, 509, 872, 236, 320,
324, 764, 254, 234, 619, 785, 302, 780, 635, 566, 506, 376, 515, 641, 255, 726,
704, 521, 559, 208, 690, 794, 200, 759, 848, 758, 277, 851, 643, 489, 749, 765,
247, 564, 751, 727, 443, 253, 486, 481, 288, 665, 547, 386, 670, 479, 221, 864,
298, 428, 763, 852, 330, 294, 878, 433, 434, 382, 242, 413, 235, 478, 586, 791,
374, 381, 493, 207, 284, 545, 642, 799, 292, 480, 514, 660, 285, 344, 708, 393,
873, 795, 669, 199, 211, 212, 336, 828, 431, 409, 596, 707, 664, 816, 850, 827,
787, 781, 308, 538, 597, 327, 269, 880, 256, 823, 518, 792, 303, 782, 863, 829,
492, 217, 334, 391, 390, 552, 869, 462, 689, 645, 338, 876, 279, 429, 268, 389,
756, 329, 846, 517, 632, 375, 713, 757, 427, 494, 210, 822, 465, 862, 535, 817,
877, 438, 766, 847, 541, 627, 353, 820, 735, 459, 356, 206, 603, 430, 634, 867,
668, 752, 442, 606, 796, 293, 280, 762, 722, 340, 240, 595, 335, 709, 244, 289,
534, 245, 844, 593, 546, 495, 633, 725, 681, 723, 866, 771, 557, 868, 530, 678,
798, 501, 378, 243, 483, 482, 343, 585, 845, 786, 694, 865, 592, 679, 607, 283,
724, 339, 328, 392, 361, 677, 680, 379, 331, 412, 385]


    label = 'Caltech_Qin_2024A'
    min_hours_visible = 1.5
    nobs_per_night = 2
    requests_allowed = other_program_fields[
    ...
    for i, field_id in enumerate(candidate_field_ids):
