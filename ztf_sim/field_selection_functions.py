...
def msip_o4_skymap_selection(time, obs_log, other_program_fields, fields,
    ...
    observable_field_ids = fields.select_field_ids(dec_range=[-90,90.],
                           grid_id=0,
    ...
    #extra_msip_fields = [252, 1246, 452, 258]      
    #field_ids_to_observe.extend(extra_msip_fields)
    #logger.info(f'Adding {extra_msip_fields} to MSIP')
...
def msip_nss_selection_phaseii(time, obs_log, other_program_fields, fields, 
    ...
    candidate_nss_field_ids = fields.select_field_ids(dec_range=[-90,90.],
                           grid_id=0,
...
843, 844, 845, 846, 847, 848, 858, 859, 860, 861, 862, 863, 864]
    ...
    visible_field_ids = fields.select_field_ids(dec_range=[-90,90.],
                           grid_id=0,
...
346, 747, 267, 656, 369, 349, 403, 272, 550, 345, 836, 548, 567, 274, 525, 528,
473, 452, 697, 273, 417, 692, 718, 662, 354, 497, 317, 401, 629, 649, 616, 503,
625, 621, 733, 398, 837, 647, 476, 858, 601, 396, 674, 371, 421, 636, 397, 271,
623, 402, 351, 399, 423, 446, 373, 472, 600, 671, 599, 739, 857, 350, 365, 746,
312, 654, 789, 571, 583, 304, 290, 637, 523, 667, 608, 355, 663, 357, 455, 622,
404, 860, 315, 319, 673, 439, 604, 440, 572, 424, 498, 814, 246, 871, 617, 450,
405, 275, 753, 719, 457, 448, 711, 348, 856, 666, 614, 414, 560, 672, 306, 499,
605, 527, 874, 818, 364, 648, 305, 578, 400, 524, 318, 761, 788, 449, 529, 715,
790, 748, 841, 720, 609, 485, 859, 543, 456, 783, 453, 425, 875, 721, 825, 522,
300, 838, 568, 251, 676, 291, 588, 655, 581, 419, 467, 706, 555, 326, 484, 734,
258, 496, 813, 301, 824, 736, 416, 500, 683, 536, 819, 519, 502, 475, 470, 325,
675, 738, 537, 646, 276, 287, 840, 296, 505, 549, 504, 745, 477, 576, 264, 693,
542, 297, 370, 558, 445, 839, 849, 554, 565, 750, 587, 447, 388, 861, 579, 265,
516, 710, 367, 661, 422, 313, 684, 252, 580, 573, 299, 755, 471, 615, 407, 842,
760, 314, 250, 531, 337, 451, 870, 415, 248, 347, 362, 620, 628, 295, 420, 341,
696, 532, 490, 602, 551, 466, 418, 464, 544, 594, 380, 793, 307, 468, 368, 491,
855, 352, 366, 533, 286, 469, 577, 520, 387, 618, 278, 556, 316]
...
def msip_nss_selection(time, obs_log, other_program_fields, fields, skymaps):
    ...
    candidate_nss_fields = fields.select_field_ids(dec_range=[-90,90.],
                           grid_id=0,
